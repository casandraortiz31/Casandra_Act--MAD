USE [master]
GO
/****** Object:  Database [TiendaSara]    Script Date: 16/10/2025 07:41:27 p. m. ******/
...
USE [TiendaSara]
GO
/****** Object:  Table [dbo].[Carritos]    Script Date: 16/10/2025 07:41:28 p. m. ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[CarritosDetalle]    Script Date: 16/10/2025 07:41:28 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Categorias]    Script Date: 16/10/2025 07:41:28 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Marcas]    Script Date: 16/10/2025 07:41:28 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Productos]    Script Date: 16/10/2025 07:41:28 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[CarritosDetalle]  WITH CHECK ADD  CONSTRAINT [FK_CarritoDetalle_Carrito] FOREIGN KEY([IdCarritos])
REFERENCES [dbo].[Carritos] ([Id])
GO
ALTER TABLE [dbo].[CarritosDetalle] CHECK CONSTRAINT [FK_CarritoDetalle_Carrito]
GO
ALTER TABLE [dbo].[CarritosDetalle]  WITH CHECK ADD  CONSTRAINT [FK_CarritoDetalle_Productos] FOREIGN KEY([IdProductos])
REFERENCES [dbo].[Productos] ([Id])
GO
ALTER TABLE [dbo].[CarritosDetalle] CHECK CONSTRAINT [FK_CarritoDetalle_Productos]
GO
